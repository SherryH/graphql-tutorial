(function (global, factory) {
	...
	(factory((global['react-apollo'] = global['react-apollo'] || {}),global.React,global.PropTypes,global.redux,global.apolloClient,global.graphqlTag,global.ReactDOM));
}(this, (function (exports,React,PropTypes,redux,apolloClient,graphqlTag,ReactDOM) { 'use strict';

graphqlTag = 'default' in graphqlTag ? graphqlTag['default'] : graphqlTag;
    ...
    function wrapWithApolloComponent(WrappedComponent) {
        ...
        var GraphQL = (function (_super) {
            ...
            function GraphQL(props, context) {
                ...
                invariant$1(!!_this.client, "Could not find \"client\" in the context of " +
                    ("\"" + graphQLDisplayName + "\". ") +
