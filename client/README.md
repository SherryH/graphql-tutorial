...
### Tutorial 2
- Create schema and make it executable
- Add graphqlExpress middleware to server
- Add GraphiQL to visually inspect queries
- Create resolvers to define schemas how to handle queries
